...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    ...
    scripts: [
      { type: "application/ld+json", children: JSON.stringify({ "@context": "https://schema.org", "@type": "Organization", legalName: "MindLoRA Private Limited", name: "Mindlora", url: "https://mindlora.com", foundingDate: "2025", description: "India-first AI recruitment interviewing service for hiring teams.", address: { "@type": "PostalAddress", streetAddress: "Bargaon, Hasanpur", addressLocality: "Samastipur", postalCode: "848205", addressRegion: "Bihar", addressCountry: "IN" } }) },
      { type: "application/ld+json", children: JSON.stringify({ "@context": "https://schema.org", "@type": "SoftwareApplication", name: "Mindlora", applicationCategory: "BusinessApplication", operatingSystem: "Web", url: "https://mindlora.com", description: "Role-specific AI interviews, scorecards, and shortlists for hiring teams." }) },
    ],
    links: [
      {
        rel: "stylesheet",
