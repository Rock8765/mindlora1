  ...
  <section className="py-20 sm:py-28">
    <div className="container-xl">
      <div className="grid gap-14 lg:grid-cols-2 lg:items-center">
        <div>
          <Reveal>
            <span className="inline-flex items-center gap-2 rounded-full border border-border bg-secondary px-3.5 py-1.5 text-xs font-semibold uppercase tracking-wider text-primary">
              Why Mindlora
            </span>
          </Reveal>
          <Reveal delay={0.05}>
          ...
          <Reveal delay={0.1}>
            <p className="mt-4 max-w-lg text-base leading-relaxed text-muted-foreground sm:text-lg">
              Mindlora runs structured first-round interviews for every applicant and returns the
              evidence your team needs to make the next decision.
            </p>
          </Reveal>
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-muted-foreground">
                    Review ranked candidates with full evidence.
                  </p>
                </div>
              </div>
            </div>
