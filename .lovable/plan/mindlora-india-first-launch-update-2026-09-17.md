...
- Replace proof points with the supplied early-stage figures, update buyer/student testimonials, reduce the team to the six specified members, and use Mumbai as the placeholder office.
- Expand buyer FAQs for pilots, GST/invoicing, seats, privacy, languages, onboarding, integrations, and low-bandwidth use.
...
- Update every public page’s India-focused title, description, canonical, social metadata, and structured data without adding misleading images.
...
- Present English and Hindi as supported; mention Marathi, Tamil, Telugu, and Bengali only as roadmap languages, not current capabilities.
